<?php
	class UserModelConstructor {
		public static function create($gamerId, $gameId, $profession, $color, $dataBaseController) {
			// user_model
			$sql = "INSERT INTO user_model (gamer_id, game_id, profession_name, is_small_path, path_position_id, path_position_left, path_position_top, color, charity_turns_left)
				VALUES ('$gamerId', '$gameId', '" . $profession['professionName'] . "', '1', '0', '-130px', '725px', '$color', '0')";
